...
<body class="bg-black">
    <section class="text-gray-200">
        ...
        <div class="w-full mx-auto container max-w-screen-xl h-screen relative space-y-8  p-10 lg:px-20 flex flex-col md:flex-row items-center justify-center">
            ...
            <form action="./backend/register.php" method="POST" class="w-full max-w-lg mx-auto md:w-1/2 border border-lime-600 p-10 bg-black shadow-xl shadow-lime-600 border-lime-600 ">
                ...
                <div class="flex flex-col items-center gap-y-5 gap-x-6 [&>*]:w-full sm:flex-row">
                    <div class="flex flex-col mb-3">
                        ...
                        <input type="name" name="full_name" placeholder="Enter your Full Name" class="text-gray-200 mt-2 px-3 py-2 bg-gray-800 border rounded-lg border-gray-900 focus:border-lime-500 focus:outline-none focus:bg-gray-800 focus:text-gray-200" autocomplete="off">
                    </div>
                    <div class="flex flex-col mb-3">
                        <label for="name">Email</label>
                        <input type="email" name="email" placeholder="Enter your email" class="text-gray-200 mt-2 px-3 py-2 bg-gray-800 border rounded-lg border-gray-900 focus:border-lime-500 focus:outline-none focus:bg-gray-800 focus:text-gray-200" autocomplete="off">
                    </div>
                </div>
                <div class="flex flex-col items-center gap-y-5 gap-x-6 [&>*]:w-full sm:flex-row">
                    <div class='flex flex-col text-gray-600 py-2' x-data="{ show: true }">
                        <div class="flex flex-col mb-3">
                            ...
                            <div class="relative mt-2">
                                ...
                                <input class="w-full min-w-0 text-gray-200 mt-2 px-3 py-2 bg-gray-800 border rounded-lg border-gray-900 focus:border-lime-500 focus:outline-none focus:bg-gray-800 focus:text-gray-200" :type="show ? 'password' : 'text'" id="password" name="password" autocomplete="current-password" placeholder="Enter your password" />
                    ...
                    <div class='flex flex-col py-2' x-data="{ showConfirm: true }">
                        ...
                        <div class="flex flex-col mb-3">
                            ...
                            <div class="relative mt-2">
                                ...
                                <input class="w-full min-w-0 text-gray-200 mt-2 px-3 py-2 bg-gray-800 border rounded-lg border-gray-900 focus:border-lime-500 focus:outline-none focus:bg-gray-800 focus:text-gray-200" :type="showConfirm ? 'password' : 'text'" id="confirm_password" name="confirm_password" autocomplete="new-confirm_password" placeholder="Repeat password" />
                                <!-- Toggle icons for showing/hiding password -->
                ...
                <div class="flex flex-col mb-3">
                    ...
                    <select id="uni" name="uni" class="text-gray-200 mt-2 px-3 py-2 bg-gray-800 border rounded-lg border-gray-900 focus:border-lime-500 focus:outline-none focus:bg-gray-800 focus:text-gray-200" autocomplete="off">
