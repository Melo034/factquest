        ...
        <a href="./index.php" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-5xl font-semibold whitespace-nowrap">
                <span style="font-family: 'Elsie Swash Caps', serif; font-weight: 900; font-style: normal;">
                    <span class="text-lime-400">FactQuest</span>
                </span>
            </span>
        </a>
        ...
        <div class="flex items-center md:order-2 md:space-x-0 rtl:space-x-reverse">
            <?php if (isset($_SESSION['id'])) { ?>
                ...
                <div>
                    <ul class="py-2 flex">
                        <li>
                            <a href="./settings.php" class="px-3 py-2 ml-2 sm:text-lg text-sm text-white hover:bg-lime-700 hover:rounded-lg">Settings</a>
                        </li>
                        <li>
                            <a href="./logout.php" class=" px-3 py-2 sm:text-lg text-sm text-white hover:bg-lime-700 hover:rounded-lg">LogOut</a>
                        </li>
                    </ul>
                </div>
            <?php } else { ?>
                <div>
                    <img src="./Images/placeholder.jpg" class="h-12 w-12 xs:h-12 xs:w-12 sm:h-12 sm:w-12 md:h-20 md:w-20 lg:h-20 lg:w-20 rounded-full object-cover mr-2 border-4 border-lime-600" alt="Default Avatar">
                </div>

                <div>
                    <ul class="py-2 flex">
                        <li>
                            <a href="./login.php" class=" px-4 py-2 sm:text-lg text-sm  text-white hover:bg-lime-700 hover:rounded-lg">Login</a>
                        </li>
                    </ul>
                </div>
            <?php } ?>
